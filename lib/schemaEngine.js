...
function compile(schema) {
  ...
  function span(lastIndex, length) {
    if(toBytePos(lastIndex) != lastIndex/8 && toBytePos(lastIndex + length) > toBytePos(lastIndex)) {
...
SchemaEngine.prototype.keys = function (schemaName) {
    return Object.keys(this.schemas[schemaName]).filter(e => e != '_length');
}
